...
import com.ubb.synergy.security.exceptions.JwtAuthenticationException;
...
public class JwtTokenService {
     ...
     */
    public String createJwtToken( final Long id, final String username, final UserRole role) {
        return Jwts.builder()
